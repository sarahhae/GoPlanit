...
Trip.destroy_all
t1 = Trip.create :title => 'South America', :date => '04-06-2021', :image => 'https://cdn-image.departures.com/sites/default/files/1529696316/cathedral-cusco-peru-CUSCOGUIDE0618.jpg'
t2 = Trip.create :title => 'North America', :date => '10-02-2022', :image => 'https://images.unsplash.com/photo-1517935706615-2717063c2225?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80.jpg'
t3 = Trip.create :title => 'Middle-East', :date => '03-03-2022', :image => 'https://i.pinimg.com/originals/f4/9e/4d/f49e4d1f91c496824de8e8dcd24a59ef.jpg'
t4 = Trip.create :title => 'Europe', :date => '14-07-2022', :image => 'https://i.pinimg.com/originals/28/ea/4b/28ea4bc54ab46010d00296b55fc46d54.jpg'
t5 = Trip.create :title => 'Southeast Asia', :date => '08-02-2023', :image => 'https://noticieroenfoque.com/wp-content/uploads/2020/02/Bagan-templo-sagrado-en-Birmania-fue-utilizado-para-filme-porno.jpg'
